...
//start screen + includes start and how to play button
void startScreen() {
  image(face, -130, -200);
...
void doorsFriend() { //scene 4.5 if player picks to bring prisoner along
  ...
  if (counter < 350) {//text displays for certain time
    fill(255);
    textSize(60);
    text("Uh Oh", 250, 270);
    textSize(40);
...
void mousePressed() {
  ...
  } else if (gameState == "noItem" || gameState == "tranq" || gameState == "arrest" || gameState == "doorsFriend" || gameState == "instructions") { // for restart button
